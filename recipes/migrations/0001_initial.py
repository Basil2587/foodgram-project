    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=300, verbose_name='Название')), # noqa
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')), # noqa
                ('title', models.CharField(choices=[('breakfast', 'Завтрак'), ('lunch', 'Обед'), ('dinner', 'Ужин'), ('salads', 'Салаты')], max_length=20, verbose_name='Название тэга')), # noqa
            ],
        ),
        migrations.CreateModel(
            name='ShoppingList',
